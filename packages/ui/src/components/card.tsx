...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground relative flex flex-col gap-6 rounded-xl border py-4 shadow-sm has-data-[slot=card-image]:overflow-clip has-data-[slot=card-image]:pt-0",
        className,
      )}
      {...props}
    />
