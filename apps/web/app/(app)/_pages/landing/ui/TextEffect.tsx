...
const createVariantsWithTransition = (
    ...
    return {
        ...
        visible: {
            ...
            transition: {
                ...(hasTransition(baseVariants.visible ?? {}) ? (baseVariants.visible as TargetAndTransition).transition : {}),
                ...mainTransition,
            },
        },
        exit: {
            ...(baseVariants.exit ?? {}),
            transition: {
                ...(hasTransition(baseVariants.exit ?? {}) ? (baseVariants.exit as TargetAndTransition).transition : {}),
                ...mainTransition,
                staggerDirection: -1,
            },
        },
